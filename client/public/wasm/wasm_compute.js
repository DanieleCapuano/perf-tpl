 ...
 * @param {number} factor
 */
export function adjust_brightness(data, factor) {
    var ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_export);
    var len0 = WASM_VECTOR_LEN;
    wasm.adjust_brightness(ptr0, len0, addHeapObject(data), factor);
}
 ...
 * @returns {Uint32Array}
 */
export function calculate_primes(n) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.calculate_primes(retptr, n);
 ...
 * @returns {any}
 */
export function compute_complex(iterations) {
    const ret = wasm.compute_complex(iterations);
...
export function quicksort(arr) {
    var ptr0 = passArrayF64ToWasm0(arr, wasm.__wbindgen_export);
    var len0 = WASM_VECTOR_LEN;
    wasm.quicksort(ptr0, len0, addHeapObject(arr));
}
 ...
 * @returns {number}
 */
export function sum_array(data) {
